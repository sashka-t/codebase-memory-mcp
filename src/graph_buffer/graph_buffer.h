...
/* Delete all nodes for a batch of file paths. Cascade-deletes referencing edges once.
 * Used by incremental indexing to purge many changed/deleted files efficiently. */
