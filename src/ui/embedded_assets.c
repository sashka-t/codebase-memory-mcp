...
extern const unsigned char _binary_assets_index_B7Ae5RVj_js_data[];
extern const unsigned int _binary_assets_index_B7Ae5RVj_js_size;
...
cbm_embedded_file_t CBM_EMBEDDED_FILES[] = {
    {"/assets/index-B7Ae5RVj.js", _binary_assets_index_B7Ae5RVj_js_data, 0, "application/javascript"},
...
static void __attribute__((constructor)) init_embedded_sizes(void) {
    ...
    files[0].size = _binary_assets_index_B7Ae5RVj_js_size;
    files[1].size = _binary_assets_index_D1_3bntm_css_size;
